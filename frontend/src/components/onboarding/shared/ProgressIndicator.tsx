            ...
            <React.Fragment key={step}>
              ...
              <button
                ...
                className={`relative flex items-center justify-center transition-all duration-300 ${
                  isCompleted
                    ? 'w-7 h-7 bg-[#1bea9a] rounded-full'
                    : isActive
                      ? 'w-8 h-8 bg-[#000000] rounded-full'
                      : 'w-6 h-6 bg-[#d0d0d3] dark:bg-gray-600 rounded-full'
              ...
              {index < visibleSteps.length - 1 && (
                <div
                  className={`h-0.5 w-6 transition-all duration-300 ${
                    isCompleted ? 'bg-[#1bea9a]' : 'bg-[#d0d0d3] dark:bg-gray-600'
                  }`}
                />
              )}
            </React.Fragment>

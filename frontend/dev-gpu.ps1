# GPU-accelerated development script for Maity (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for Maity" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting Maity in development mode..." -ForegroundColor Blue
Write-Host ""

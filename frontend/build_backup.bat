@echo off
REM Maity Build Script for Windows
...
echo 🚀 Building Maity application...
...
echo.
echo DESCRIPTION:
echo   This script builds the Maity Tauri application for Windows.
